...
public class BzReflectionTests
{
    ...
    public void GetValue_Throws_IfFieldIsNotFound()
    {
        ...
        var ex = Assert.Throws<InvalidOperationException>(() => BzReflection.GetValue<string>(demo, "UnknownField"));
        ex.Message.Should().Match("*property*field*UnknownField*DemoClass*");
    }
